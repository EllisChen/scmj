...
//摸牌
//Ellis: Game 表示每一局  mahjongs: 每一局的所有牌
function mopai(game,seatIndex) {
    if(game.currentIndex == game.mahjongs.length){
        return -1;
    }
    //Ellis: Data表示当前这个人的牌数据
    var data = game.gameSeats[seatIndex];
    var mahjongs = data.holds; //Ellis: 手牌
...
function doGameOver(game,userId,forceEnd){
    ...
    var results = [];
    var dbresult = new Array(numberPlayers);
...
function store_history(roomInfo){
    ...
    var history = {
        ...
        seats:new Array(roomInfo.conf.numberPlayers)
    };
